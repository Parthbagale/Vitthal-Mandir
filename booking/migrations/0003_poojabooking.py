# Generated by Django 5.1.2 on 2025-08-24 06:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('booking', '0002_entryverification'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pooja_bookings', to=settings.AUTH_USER_MODEL)),
            ],
            options={
